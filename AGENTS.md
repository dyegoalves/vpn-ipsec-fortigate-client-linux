...
This project is indexed by GitNexus as **vpn-ipsec-fortigate-client-linux** (661 symbols, 822 relationships, 11 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
