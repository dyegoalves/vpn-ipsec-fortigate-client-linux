...
This project is indexed by GitNexus as **vpn-ipsec-fortigate-client-linux** (693 symbols, 859 relationships, 12 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
